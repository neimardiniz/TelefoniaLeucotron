 ...
 <nav>
  ...
  <li><a href="index.php"  >Login</a>
    ...
    <li> 
      ...
      <a href="<?php echo "$link"; ?>" target="conteudo" >Supervisao</a></li>
    ...
    <li> 
      ...
      <ul id="btn-preloadr2">
        <li><a href="acompanhamentonovo.php"  target="conteudo">Acompanhamento</a></li>
        <li ><a href="acompcompleto.php"  target="conteudo">Analise de chamadas</a></li>
 ...
 <li><a href="http://192.168.254.208/sic/index.php" target="_blank" >Sic</a>
     ...
     <li> 
      ...
      <ul id="btn-preloadr2">
        ...
        <li ><a href="http://192.168.254.208/sic/modulos/supervisao"  target="_blank">Supervisao</a></li>
		<li ><a href="http://192.168.254.208/sic/modulos/vendas/index.php"  target="_blank">Resumo Vendas</a></li>
...
Aguarde, verificando disponibilidade do contaction:
<p></p>
 <img src="imagens/load.gif" > 
  ...
  <!-- Footer -->
    ...
    <div class="footer" id="footer" >
      ...
      Copyright &copy; Cofer Atacadista - v.1.2.0
